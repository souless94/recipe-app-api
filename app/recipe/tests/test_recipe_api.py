...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipe_by_tags(self):
        ...
        recipe2 = sample_recipe(self.user, title='Hawalian pizza')
        tag1 = sample_tag(self.user, 'Vegan')
        tag2 = sample_tag(self.user, 'Pizza')
    ...
    def test_filter_recipe_by_ingredients(self):
        ...
        recipe1 = sample_recipe(self.user, title='Garlic Bread')
        recipe2 = sample_recipe(self.user, title='Mac and cheese')
        ingredient1 = sample_ingredient(self.user, 'Bread')
        ingredient2 = sample_ingredient(self.user, 'Cheese')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(self.user, title='Hk Noodle')
